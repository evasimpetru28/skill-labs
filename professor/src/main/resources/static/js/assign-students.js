...
function checkExpired(quizId, superuserId) {
    let expiredCheckbox = document.getElementById("expired")
    console.log(expiredCheckbox.checked)
    if (expiredCheckbox.checked) {
        console.log("marked as expired")
        $.ajax({
            type: "POST",
            url: "/make-expired/" + quizId + "/" + superuserId,
            dataType: "html",
            contentType: 'application/json',
            mimeType: 'application/json',
            timeout: 100000,
        ...
        console.log("not expired, just save")
        $.ajax({
        type: "POST",
            url: "/ready-quiz/" + quizId + "/" + superuserId,
            dataType: "html",
            contentType: 'application/json',
            mimeType: 'application/json',
            timeout: 100000,
